...
namespace RayTracingTutorial09.RTX
{
    public class AccelerationStructures
    {
        ...
        public unsafe AccelerationStructureBuffers CreateTopLevelAS(ID3D12Device5 pDevice, ID3D12GraphicsCommandList4 pCmdList, ID3D12Resource pBottomLevelAS, ref long tlasSize)
        {
            ...
            FixedRaytracingInstanceDescription[] pInstanceDesc = new FixedRaytracingInstanceDescription[3];
            ...
            {                
                ...
                pInstanceDesc[i].AccelerationStructure = pBottomLevelAS.GPUVirtualAddress;
                pInstanceDesc[i].InstanceMask = 0xff;
            }

            IntPtr data;
            data = buffers.pInstanceDesc.Map(0, null);
            Helpers.MemCpy(data, pInstanceDesc, (uint)Unsafe.SizeOf<FixedRaytracingInstanceDescription>() * 3);
