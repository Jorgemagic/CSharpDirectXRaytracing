    ...
    public class Scene
    {
        ...
        public unsafe void CreateShaderTable()
        {
            ...
            */
            ...
            for (int i = 0; i < this.acs.Instances; i++)
            {
        ...
        public void CreateShaderResources()
        {
            ...
            // CB Scene
            Vector3 cameraPosition = new Vector3(0, 1.5f, 5);
            Matrix4x4 view = Matrix4x4.CreateLookAt(cameraPosition, new Vector3(0, 1.5f, 0), Vector3.UnitY);
            ...
            sceneConstantBuffer = new SceneConstantBuffer()
            {
                ...
                lightPosition = new Vector3(0.0f, 2.8f, 0.0f),
                lightDiffuseColor = new Vector4(1.0f, 1.0f, 1.0f, 1.0f),
                lightAmbientColor = new Vector4(0.5f, 0.5f, 0.5f, 1.0f),
        ...
        {
            PrimitiveConstantBuffer[] primitiveConstantBuffer = new PrimitiveConstantBuffer[this.acs.Instances];
            ...
            {
                diffuseColor = new Vector4(0.0f, 1.0f, 0.0f, 1.0f),
                materialType = MaterialTypes.Lambertian,
            };
            primitiveConstantBuffer[2] = new PrimitiveConstantBuffer()
            {
                diffuseColor = new Vector4(1.0f, 0.0f, 0.0f, 1.0f),
                materialType = MaterialTypes.Lambertian,
            };
            ...
            primitiveConstantBuffer[6] = new PrimitiveConstantBuffer()
            {
                diffuseColor = new Vector4(1.0f, 1.0f, 1.0f, 1.0f),
                materialType = MaterialTypes.Lambertian,
            };

            this.primitivesCB = new ID3D12Resource[primitiveConstantBuffer.Length];
