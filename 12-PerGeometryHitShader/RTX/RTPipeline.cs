...
namespace RayTracingTutorial12.RTX
{
    public class RTPipeline
    {
        ...
        {
            // Compile the shader
            IDxcBlob pDxilLib = this.CompileLibrary("Data/12-Shaders.hlsl", new DxcShaderModel(6, 3));
            string[] entryPoints = new string[] { kRayGenShader, kMissShader, kPlaneChs, kTriangleChs };
