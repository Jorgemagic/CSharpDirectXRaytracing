...
namespace RayTracingTutorial16.RTX
{
    ...
    {       
        ...
        public void CreatePrimitive(ID3D12Device5 pDevice)
        {
        ...
        public AccelerationStructureBuffers CreateBottomLevelAS(ID3D12Device5 pDevice, ID3D12GraphicsCommandList4 pCmdList)
        {
            ...
            geomDesc.Triangles.VertexBuffer.StartAddress = VertexBuffer.GPUVirtualAddress;
            ...
            geomDesc.Triangles.IndexBuffer = IndexBuffer.GPUVirtualAddress;
