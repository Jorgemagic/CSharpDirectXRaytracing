using RayTracingTutorial14.RTX;
...
namespace RayTracingTutorial14
{
    public class Scene
    {
        ...
        public void CreateAccelerationStructures()
        {
            ...
            // Create the TLAS
            acs.BuildTopLevelAS(mpDevice, mpCmdList, mpBottomLevelAS, ref mTlasSize, 0, false, ref mTopLevelBuffers);
        ...
        public void CreateRtPipelineState()
        {
            ...
            int triHitRootIndex = index++; // 6
            ExportAssociation triHitRootAssociation = new ExportAssociation(new string[] { RTPipeline.kTriangleChs }, subobjects[triHitRootIndex]);
            subobjects[index++] = triHitRootAssociation.subobject; // 7 Associate Hit Root Sig to Hit Group
        ...
        public void CreateShaderResources()
        {
            ...
            srvDesc.RaytracingAccelerationStructure.Location = mTopLevelBuffers.pResult.GPUVirtualAddress;
        ...
        public bool DrawFrame(Action<int, int> draw, [CallerMemberName] string frameName = null)
        {
            ...
            this.acs.BuildTopLevelAS(mpDevice, mpCmdList, mpBottomLevelAS, ref mTlasSize, mRotation, true, ref mTopLevelBuffers);
            mRotation += 0.005f;
