...
namespace RayTracingTutorial15.RTX
{
    public static class Primitives
    {
        ...
        public static void Quad(float size, out List<VertexPositionNormalTangentTexture> vertexData, out List<ushort> indexData, bool uvHorizontalFlip = false, bool uvVerticalFlip = false, float uTileFactor = 1, float vTileFactor = 1)
        {
            VertexPositionNormalTangentTexture[] vertices = new VertexPositionNormalTangentTexture[]
            {
                // Indexed Quad
                new VertexPositionNormalTangentTexture(new Vector3(-100f, -1f, -100f), Vector3.Zero, Vector3.Zero, Vector2.Zero),
                new VertexPositionNormalTangentTexture(new Vector3( 100f, -1f, -100f), Vector3.Zero, Vector3.Zero, Vector2.Zero),
                new VertexPositionNormalTangentTexture(new Vector3( 100f, -1f, 100f), Vector3.Zero, Vector3.Zero, Vector2.Zero),
                new VertexPositionNormalTangentTexture(new Vector3(-100f, -1f, 100f), Vector3.Zero, Vector3.Zero, Vector2.Zero),
            };
