using RayTracingTutorial06.RTX;
using RayTracingTutorial06.Structs;
using System;
...
namespace RayTracingTutorial06
{
    public class Scene
    {
        ...
        public void CreateShaderResources()
        {
            ...
            var mpOutputResource = mpDevice.CreateCommittedResource(AccelerationStructures.kDefaultHeapProps, HeapFlags.None, resDesc, ResourceStates.CopySource, null);  // Starting as copy-source to simplify onFrameRender()

            // Create an SRV/UAV descriptor heap. Need 2 entries - 1 SRV for the scene and 1 UAV for the output
            ID3D12DescriptorHeap mpSrvUavHeap = this.context.CreateDescriptorHeap(mpDevice, 2, DescriptorHeapType.ConstantBufferViewShaderResourceViewUnorderedAccessView, true);
